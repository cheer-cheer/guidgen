...
{
    public class DefineGuidFormatter
         : IGuidFormatter 
    {
        private readonly string name;

        public DefineGuidFormatter()
        {
            name =  SR.Formatter_DefineGuidFormatterName;
        }
        ...
        public string Format(Guid value)
        {
            ...
            result.AppendLine("}");
            result.Append("DEFINE_GUID(<<").Append(SR.Formatter_DefineGuidFormatter_ObjectName).Append(">>, ").AppendLine();
