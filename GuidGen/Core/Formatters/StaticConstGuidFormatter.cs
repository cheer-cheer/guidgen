...
{
    public class StaticConstGuidFormatter
         : IGuidFormatter 
    {
        private readonly string name;

        public StaticConstGuidFormatter()
        {
            name = SR.Formatter_StaticConstGuidFormatterName;
        }
        ...
        public string Format(Guid value)
        {
            ...
            result.AppendLine("}");
            result.Append("static const GUID <<").Append(SR.Formatter_StaticConstGuidFormatter_Name).Append(">> = ").AppendLine();
